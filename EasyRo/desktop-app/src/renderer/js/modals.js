...
function initQuestionModal() {
  ...
  if (textInput) {
    ...
    textInput.addEventListener('keydown', (e) => {
      ...
      if (e.key === 'Enter' && activeOptionIndex >= 0 && !inConfirmMode) {
        e.preventDefault();
...
window.Modals = { showQuestionModal, closeQuestionModal, rejectQuestionModal, initQuestionModal, showRevertModal, closeRevertModal, initRevertModal };
